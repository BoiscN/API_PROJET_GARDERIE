    ...
    public class DepenseRepository : Repository
    {
        ...
        public List<DepenseDTO> ObtenirListeDepense(string nomGarderie)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    DepenseDTO depense = new DepenseDTO(reader.GetString(1), reader.GetDouble(2));
                    liste.Add(depense);
                }
                reader.Close();
                return liste;
        ...
        public DepenseDTO ObtenirDepense(string nomGarderie, string dateTemps)
        {
            ...
            try
            {
                ...
                SqlDataReader reader = command.ExecuteReader();
                reader.Read();
                uneDepense = new DepenseDTO(reader.GetString(0), reader.GetDouble(1));
                reader.Close();
                return uneDepense;
            }
            catch (Exception ex)
        ...
        public void AjouterDepense(string nomGarderie, DepenseDTO depenseDTO)
        {
            ...
            command.CommandText = " INSERT INTO Departements (DateTemps, Montant, IdGarderie, IdCategorieDepense, IdCommerce) " +
